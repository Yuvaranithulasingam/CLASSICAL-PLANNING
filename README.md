...
## AIM:
To solve Implementation of Classical Planning Algorithm using python.<br>

## Algorithm or Steps Involved:

Define the initial state<br>
Define the goal state<br>
Define the actions<br>
Find a plan to reach the goal state<br>
Print the plan<br>
...
![{653C79B0-F6C4-47C6-A41B-6D6847C9C4DE}](https://github.com/user-attachments/assets/c614c0fc-b059-4557-aa71-6a5f71e70694)
